...
const Love = () => {
  const [address, setAddress] = useState<Address>('0xA0Cf798816D4b9b9866b5330EEa46a18382f251e')
  ...
  return (
    <div>
      ...
      <button onClick={() => setAddress(value as Address)}>{isFetching ? (isRefetching ? 'refetching...' : 'fetching...') : 'fetch'}</button>
